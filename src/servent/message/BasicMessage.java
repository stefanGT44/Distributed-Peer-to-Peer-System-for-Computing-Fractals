...
public class BasicMessage implements Message {
	...
	private final ServentInfo recieverInfo;
	...
	public BasicMessage(MessageType type, ServentInfo senderInfo, ServentInfo recieverInfo) {
		this.type = type;
	...
	public BasicMessage(MessageType type, ServentInfo senderInfo, ServentInfo recieverInfo, String messageText) {
		this.type = type;
		this.senderInfo = senderInfo;
		this.recieverInfo = recieverInfo;
	...
	@Override
	public ServentInfo getRecieverInfo() {
	...
	public String toString() {
		return "[Sender: " + senderInfo.getId() + "|" + getMessageId() + "|" +
					getMessageText() + "|" + getMessageType() + "|Reciever: " +
					recieverInfo.getId() + "]";
	}
