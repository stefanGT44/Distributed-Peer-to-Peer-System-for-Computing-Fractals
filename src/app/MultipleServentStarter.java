...
public class MultipleServentStarter {
	...
	private static void startServentTest(String testName) {
		...
		ProcessBuilder bsBuilder = new ProcessBuilder("java", "-cp", "bin/", "app.BootstrapServer", String.valueOf(AppConfig.bootstrapInfo.getListenerPort()));
		bsBuilder.redirectOutput(new File(testName+"/output/bs.txt"));
