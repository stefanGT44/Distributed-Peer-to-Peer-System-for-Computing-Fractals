...
The system can <b>concurrently</b> compute one or more fractals. When nodes join/leave the network, if it is optimal <b>the system reorganizes (balances) the workload</b>. <br>
